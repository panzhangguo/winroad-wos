    ...
    children: [
      {
        ...
        meta: {
          ...
          hideInMenu: false,
          order: 10,
          i18nKey: 'menu.serviceOrderList',
        },
      },
      {
        path: '/service-orders/add',
        name: 'service-orders:add',
        component: '/commerce/AddOrder',
        meta: {
          title: '添加服务单',
          icon: 'Plus',
          keepAlive: false,
